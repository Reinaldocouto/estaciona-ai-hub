-- Inserir as 16 novas vagas na região da Av. Paulista
INSERT INTO public.vagas (
  id, titulo, endereco, price, preco_hora, preco_dia, preco_mes, lat, lng, 
  bairro, cidade, rating, available, features, recursos, image_url, discount_premium
) VALUES 
-- Vaga 25: Garagem Privativa Paulista Executive
('25', 'Garagem Privativa Paulista Executive', 'Av. Paulista, 854 - São Paulo, SP', 
...
-- Vaga 26: Estacionamento Subsolo Augusta  
('26', 'Estacionamento Subsolo Augusta', 'R. Augusta, 2532 - São Paulo, SP', 
...
-- Vaga 27: Garagem Conjunto Nacional
('27', 'Garagem Conjunto Nacional', 'Av. Paulista, 2073 - São Paulo, SP', 
...
-- Vaga 28: Vaga Privativa Bela Vista Premium
('28', 'Vaga Privativa Bela Vista Premium', 'R. Dr. Plínio Barreto, 285 - São Paulo, SP', 
...
-- Vaga 29: Estacionamento Rotativo Paulista Center
('29', 'Estacionamento Rotativo Paulista Center', 'Av. Paulista, 1294 - São Paulo, SP', 
...
-- Vaga 30: Garagem Subsolo Paulista Plaza
('30', 'Garagem Subsolo Paulista Plaza', 'Av. Paulista, 2064 - São Paulo, SP', 
...
-- Vaga 31: Vaga Corporativa Fiesp Tower
('31', 'Vaga Corporativa Fiesp Tower', 'Av. Paulista, 1313 - São Paulo, SP', 
...
-- Vaga 32: Estacionamento Hospital Sírio Libanês
('32', 'Estacionamento Hospital Sírio Libanês', 'R. Dona Adma Jafet, 91 - São Paulo, SP', 
...
-- Vaga 33: Garagem Residencial Jardins Elite
('33', 'Garagem Residencial Jardins Elite', 'R. Augusta, 1508 - São Paulo, SP', 
...
-- Vaga 34: Estacionamento Bela Vista Business
('34', 'Estacionamento Bela Vista Business', 'R. Treze de Maio, 1947 - São Paulo, SP', 
...
-- Vaga 35: Garagem Shopping Center 3
('35', 'Garagem Shopping Center 3', 'Av. Paulista, 2064 - São Paulo, SP', 
...
-- Vaga 36: Vaga Privativa Consolação Premium
('36', 'Vaga Privativa Consolação Premium', 'Av. Consolação, 3811 - São Paulo, SP', 
...
-- Vaga 37: Estacionamento Banco Central Tower
('37', 'Estacionamento Banco Central Tower', 'Av. Paulista, 1776 - São Paulo, SP', 
...
-- Vaga 38: Garagem Cultural Sesc Paulista
('38', 'Garagem Cultural Sesc Paulista', 'Av. Paulista, 119 - São Paulo, SP', 
...
-- Vaga 39: Vaga Exclusiva Jardins Medical Center
('39', 'Vaga Exclusiva Jardins Medical Center', 'R. Pamplona, 518 - São Paulo, SP', 
...
-- Vaga 40: Estacionamento Paulista Innovation Hub
('40', 'Estacionamento Paulista Innovation Hub', 'Av. Paulista, 2300 - São Paulo, SP', 
