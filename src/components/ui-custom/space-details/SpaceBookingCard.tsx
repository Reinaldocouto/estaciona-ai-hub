      ...
      <CardContent className="p-6">
        <div className="flex justify-between items-center mb-6">
          <div className="text-2xl font-bold text-white">
            ...
            <span className="text-gray-300 text-sm font-normal">/hora</span>
          </div>
          <div className="flex items-center">
            <Star className="w-5 h-5 text-yellow-500 fill-yellow-500 mr-1" />
            <span className="font-bold text-white">{space.rating}</span>
          </div>
        </div>

        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium mb-1 text-white">Data</label>
            <Input
              type="date"
              value={selectedDate}
          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="border-t pt-2 font-semibold flex justify-between text-white">
              <span>Total</span>
        ...
        <div className="mt-6 bg-gray-800 rounded-lg p-4 text-sm">
          <div className="flex">
            ...
            <p className="text-white">Pagamento seguro e garantido com proteção ao consumidor.</p>
          </div>
        </div>
      </CardContent>
    </Card>
